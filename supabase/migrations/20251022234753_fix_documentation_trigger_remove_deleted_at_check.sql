/*
  # إصلاح trigger التوثيق - إزالة deleted_at من documentation
  
  1. التغييرات
    - إزالة شرط deleted_at من documentation (الجدول لا يحتوي على هذا العمود)
    - التحقق فقط من وجود توثيق سابق للحجز
    
  2. الأمان
    - الدالة تعمل بشكل صحيح بدون deleted_at
*/

-- إعادة إنشاء الدالة بدون deleted_at
...
COMMENT ON FUNCTION auto_create_documentation_on_status_change() IS 'Creates documentation certificate when reservation booking_status becomes documented';
