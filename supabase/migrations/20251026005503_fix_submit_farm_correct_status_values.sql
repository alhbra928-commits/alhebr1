/*
  # إصلاح قيم status في submit_farm_for_review
  
  المشكلة:
  - status = 'متاح' ❌ (غير مسموح)
  - القيم المسموحة: 'active', 'frozen', 'under_review', 'archived'
  
  الحل:
  - استخدام 'active' بدلاً من 'متاح'
*/
...
BEGIN
  ...
  VALUES (
    ...
    p_price_per_tree,
    p_actual_total_price * 0.08,
    p_payment_grace_period,
    p_additional_notes,
    p_location_lat,
    p_location_lng,
    'active',      -- ✅ القيمة الصحيحة
