/*
  # إصلاح trigger التوثيق - إزالة customer_email
  
  1. التغييرات
    - إزالة customer_email من INSERT (الحقل غير موجود في reservations)
    - استخدام NULL للإيميل أو البحث عنه من investors
    
  2. الأمان
    - الدالة تعمل بشكل صحيح
*/

-- إعادة إنشاء الدالة بدون customer_email
...
COMMENT ON FUNCTION auto_create_documentation_on_status_change() IS 'Creates documentation certificate when reservation booking_status becomes documented - fixed to use correct fields';
