/*
  # إصلاح دالة submit_farm_for_review لتطابق بنية الجدول

  1. تحديث الدالة لتتوافق مع الأعمدة الموجودة فعلياً
  2. إزالة mobile_number و total_trees_count من INSERT
  3. تخزين هذه البيانات في submitted_data بدلاً من ذلك
*/
...
BEGIN
  ...
  -- إنشاء طلب المراجعة (بدون mobile_number و total_trees_count)
