/*
  # تحديث دالة find_matching_auto_response لإرجاع whatsapp_business_link بوضوح
  
  التعديلات:
  - إضافة حقل whatsapp_business_link صريحاً في النتيجة
  - إضافة حقل use_hybrid_message للتحكم في نوع الرابط
*/
...
'دالة البحث عن رد تلقائي مع دعم الرد الافتراضي - ترجع whatsapp_business_link بوضوح';
