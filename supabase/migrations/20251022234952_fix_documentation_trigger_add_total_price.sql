/*
  # إصلاح trigger التوثيق - إضافة total_price
  
  1. التغييرات
    - إضافة total_price = total_amount
...
COMMENT ON FUNCTION auto_create_documentation_on_status_change() IS 'Creates documentation certificate when reservation booking_status becomes documented - complete with all required fields';
