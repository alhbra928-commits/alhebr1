/*
  # إصلاح تعارض دالة submit_farm_for_review

  1. حذف جميع النسخ القديمة من الدالة
  2. إنشاء نسخة واحدة نهائية مع جميع المعاملات
*/

-- حذف جميع النسخ القديمة
DROP FUNCTION IF EXISTS submit_farm_for_review(
  uuid, text, text, text, text, text, numeric, text, text, numeric, numeric, integer, decimal, decimal, text, jsonb
);

DROP FUNCTION IF EXISTS submit_farm_for_review(
  uuid, text, text, text, text, text, numeric, text, text, numeric, numeric, integer, numeric, numeric, text, jsonb, text, text, text, text, text
);

DROP FUNCTION IF EXISTS submit_farm_for_review(
  uuid, text, text, text, text, text, numeric, text, text, numeric, numeric, integer, numeric, numeric, text, jsonb, text, text, text, text, text, text
);

-- إنشاء الدالة النهائية الوحيدة
