...
## 🆘 استعادة المشروع من الصفر

**دليل شامل للحماية من الضياع:** اقرأ [`RECOVERY_GUIDE.md`](./RECOVERY_GUIDE.md)

### ملخص سريع:
```bash
git clone [your-repo-url]
cp .env.example .env
# املأ القيم الحقيقية من مكان آمن
npm install
npm run build
npm run dev
```

⚠️ **مهم جداً:** احفظ نسخة من ملف `.env` في 3 أماكن آمنة على الأقل!
