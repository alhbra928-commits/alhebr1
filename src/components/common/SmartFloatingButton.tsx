    ...
    <>
      ...
      {isOpen && (
        ...
        >
          ...
          <div className="p-3 bg-gray-900 border-t border-gray-700 flex-shrink-0 safe-area-bottom">
            <div className="flex items-end gap-2">
              {/* WhatsApp Button - Optimized size */}
              <a
                href="https://wa.me/966569335257"
                target="_blank"
                rel="noopener noreferrer"
                className="flex-shrink-0 w-11 h-11 rounded-xl bg-gradient-to-br from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 flex items-center justify-center transition-all duration-300 hover:scale-105 active:scale-95 shadow-lg hover:shadow-green-500/50"
              ...
              {/* Input with better mobile optimization */}
              <div className="flex-1 flex items-end gap-2">
                <input
                  ...
                  disabled={sending}
                  className="flex-1 px-3 py-2.5 bg-gray-800 border border-gray-700 rounded-xl text-white text-sm placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-[#A0916A] disabled:opacity-50"
                  style={{ fontSize: '16px' }}
                />
                <button
                  onClick={handleSendMessage}
                  disabled={!inputMessage.trim() || sending}
                  className="w-11 h-11 rounded-xl flex items-center justify-center transition-all disabled:opacity-50 disabled:cursor-not-allowed active:scale-95 flex-shrink-0"
                  style={{
