...
export function MainPlatformInterface({
  ...
  return (
    ...
    >
      ...
      {/* Smart Bottom Dock - Ultimate iOS Safari Fix */}
      <SmartBottomDock
        ...
        items={[
          {
            ...
            onClick: () => {
              console.log('[SmartDock] Navigate to home');
          ...
          },
          {
            ...
            onClick: () => {
              console.log('[SmartDock] Navigate to account');
          ...
          },
          {
            ...
            onClick: () => {
              console.log('[SmartDock] Smart button clicked');
            }
          },
          {
            id: 'contact',
