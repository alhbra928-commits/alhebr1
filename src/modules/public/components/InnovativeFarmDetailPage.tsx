    ...
    >
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          ...
          >
            <ArrowRight style={{ width: '20px', height: '20px', color: '#1f2937' }} />
          </button>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            ...
            >
              <Share2 style={{ width: '20px', height: '20px', color: '#4b5563' }} />
            </button>
          </div>
        </div>
      </div>

      {/* ============ المحتوى القابل للسكرول - منفصل تماماً ============ */}
      <div
        style={{
          flex: 1,
          overflowY: 'auto',
