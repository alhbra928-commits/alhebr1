...
import { Settings, Map, Video, Mail, Key, Globe, Bell, Shield, Database, BarChart3, Package, Activity, Type, PanelLeftClose, Loader2, TrendingUp, Building2 } from 'lucide-react';
...
export function SettingsView({ onBack }: SettingsViewProps) {
  const [activeTab, setActiveTab] = useState<'general' | 'backup' | 'versions' | 'diagnostics' | 'texts' | 'side-dock' | 'loader' | 'activity-bar' | 'footer'>('general');
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8 flex gap-4 flex-wrap">
          ...
          <button
            ...
            className={`flex items-center gap-2 px-6 py-3 rounded-xl font-medium transition-all ${
              activeTab === 'footer'
                ? 'bg-gradient-to-r from-[#1A472A] to-[#2C5F2D] text-white shadow-lg'
                : 'bg-white text-[#2C2C2C] hover:bg-[#F4EBDD]'
            }`}
          >
