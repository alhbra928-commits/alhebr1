            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  className="group relative flex items-center gap-2 px-6 py-3 rounded-xl font-black text-white transition-all hover:scale-105 active:scale-95 overflow-hidden"
                  style={{
                ...
                >
                  ...
                  <Globe className="relative h-5 w-5 transition-transform group-hover:rotate-12" />
                  <span className="relative">🌍 استكشاف المنصة</span>
                </button>
                ...
                >
                  ...
                  <span className="relative">إنهاء الجلسة</span>
                </button>
                ...
                >
                  ...
                  <span className="relative">خروج</span>
                </button>
