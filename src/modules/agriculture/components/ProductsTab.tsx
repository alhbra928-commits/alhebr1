  ...
  return (
    <div className="space-y-6">
      <div className="text-center py-20">
        <div className="inline-block p-6 bg-gradient-to-br from-blue-50 to-cyan-50 rounded-2xl border-2 border-blue-200 mb-6">
          ...
          <div className="max-w-2xl mx-auto">
            <div className="bg-white/80 backdrop-blur-sm rounded-xl p-6 border-2 border-blue-300 shadow-lg">
              ...
              <div className="pt-4 border-t-2 border-blue-200">
                ...
                <ul className="text-right space-y-2 text-[#2C2C2C]/80">
                  <li className="flex items-center gap-2">
                    ...
                    <span>إدارة المنتجات الزراعية</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="w-2 h-2 bg-blue-500 rounded-full"></span>
                    <span>تتبع المحاصيل والإنتاج</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="w-2 h-2 bg-blue-500 rounded-full"></span>
                    <span>خدمات التعبئة والتغليف</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="w-2 h-2 bg-blue-500 rounded-full"></span>
                    <span>التوزيع والتسليم للمستثمرين</span>
                  </li>
                </ul>
              </div>
